    ...
    <div class="row page-titles">
        <div class="col-md-9 col-9 align-self-center">
            <h3 class="text-themecolor"><?= $page_title ?>
                <button class="btn btn-success" data-toggle="tooltip" title="" onclick="window.open('<?= base_url() ?>laporan/cetak?type=daily&date=<?= $filter['date']?>')" data-original-title="Cetak Laporan"><i class="mdi mdi-printer"></i>cetak</button>
            </h3>
            <ol class="breadcrumb">
